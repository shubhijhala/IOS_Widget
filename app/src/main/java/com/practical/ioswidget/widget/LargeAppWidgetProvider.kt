...
class LargeAppWidgetProvider : AppWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds: IntArray
         ...
         for (appWidgetId in appWidgetIds) {
             ...
             val remoteView = RemoteViews(context.packageName, R.layout.widget_large)
             remoteView.setOnClickPendingIntent(R.id.largeWidgetLayout, pendingIntent)
